...
// Set language
//echo $_SESSION['tiny_upload'][$_COOKIE['instance']];
...
<script type="text/javascript">
    ...
    var currentFrame = iframes[3];
var currCookie = getCookie('instance');

if(currCookie != tinyMCE.activeEditor.editorId) {
setCookie('instance',tinyMCE.activeEditor.editorId);
    var docBody = document.body;
  window.onload = function() {
      currentFrame.contentWindow.location.reload(true);
  }
}
...
<li id="article_tab"><span><a href="article.php?type=<?php echo $typenow.$passfeid ; ?>"><?php echo TB_ARTICLES; ?></a></span></li>
