...
<li id="article_tab" class="current"><span><a href="menu.php?type=<?php echo $typenow.$passfeid ; ?>"><?php echo TB_MENU; ?></a></span></li><?php
} ?>
</ul>
</div>
...
<fieldset>
<legend><?php echo TB_SELECTMENU; ?></legend>
<?php
